...
class Acura extends StatefulWidget {
  @override
  _AcuraState createState() => _AcuraState();
}

class _AcuraState extends State<Acura> {
  @override
  ...
  Widget _drawProducts() {
    return StreamBuilder<QuerySnapshot>(
      stream: Firestore.instance.collection('acurt').snapshots(),
